  ...
  <div class="customer-management">
    ...
    >
      ...
      >
        ...
        <a-form-item label="亚马逊店铺名称" name="amazonStore">
          <a-input
            v-model:value="formData.amazonStore"
            placeholder="请输入亚马逊店铺名称"
          />
        </a-form-item>
    ...
    >
      <a-descriptions :column="2" bordered>
        ...
        <a-descriptions-item label="亚马逊店铺名称">
          {{ currentUser.amazonStore || '无' }}
        </a-descriptions-item>
...
const handleEdit = (record) => {
  ...
  Object.assign(formData, {
    ...
    amazonStore: record.amazonStore || '',
